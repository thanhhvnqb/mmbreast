...
model = dict(
    ...
    with_arcface=True,
    arcface_cfg=dict(loss_module=dict(type="CrossEntropyLoss", loss_weight=1.0)),
...
work_dir = f"./work_folder/from_imagenet/efficient-b3-fold_{fold}-ce_loss-arcface_1.0/"
