    ...
    if args.checkpoint and os.path.isfile(args.checkpoint):
        ...
        if isinstance(checkpoint, dict):
            ...
            if state_dict_key in checkpoint:
                new_checkpoint["state_dict"] = checkpoint[state_dict_key]
            else:
        ...
        try:
            torch.save(new_checkpoint, _TEMP_NAME, _use_new_zipfile_serialization=False)
        except:
            torch.save(new_checkpoint, _TEMP_NAME)
